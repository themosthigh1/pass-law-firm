const heroClassNames = {
  ...
  button:
    "mt-8 sm:mt-10 inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-[40px] shadow-sm text-white bg-primary hover:bg-yellow-300 sm:px-8 transition-all duration-200",
  buttonSpan: "ml-4",
  imageContainer:
