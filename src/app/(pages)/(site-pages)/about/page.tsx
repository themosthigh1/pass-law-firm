  ...
  return (
    <div>
      ...
      <div className="px-6 sm:px-12 md:px-20 lg:px-36 mx-auto pb-8 text-black mb-28">
        ...
        <p>
          Whether you are facing charges related to theft, drug offenses, DUI,
          assault, or any other criminal matter, we will tirelessly work to
          build a solid defense, challenge evidence, negotiate with prosecutors,
          and strive for the best possible outcome in your case. Your future and
          reputation are of paramount importance to us, and we are here to stand
          by your side, ensuring that you receive the fair and just treatment
